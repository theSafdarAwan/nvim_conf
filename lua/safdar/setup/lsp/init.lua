...
---@field lsp_signature_nvim Plugin show docs for Lsp symbols.
---@field trouble_nvim Plugin shows diagnostics for the lsp in a window like vscode.
---@field lspsaga_nvim Plugin show diagnostics messages in a file.
...
---@field nvim_navic Plugin show lsp symbol context in nav bar like vscode.
