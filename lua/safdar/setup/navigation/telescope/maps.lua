...
M.maps = function()
	...
	set_map("n", "<leader>gtd", function()
		require("safdar.setup.navigation.telescope.telescope-custom").gtd_neorg_files()
	end, { noremap = true, silent = true })
	...
	set_map("n", "<leader>tc", function()
		require("safdar.setup.navigation.telescope.telescope-custom").get_cursor_change_colorscheme()
	end, { noremap = true, silent = true })

	set_map("n", "<leader>ti", function()
		require("safdar.setup.navigation.telescope.telescope-custom").ivy_colorscheme_preview()
	end, { noremap = true, silent = true })

	set_map("n", "<leader>ff", function()
		-- ":Telescope find_files theme=get_cursor previewer=false find_command=rg,--hidden,--files<CR>",
		require("safdar.setup.navigation.telescope.telescope-custom").center_list_find_files()
	end, { noremap = true, silent = true })

	set_map("n", "<C-_>", function()
		require("safdar.setup.navigation.telescope.telescope-custom").current_buffer_fuzzy_find()
	end, { noremap = true, silent = true })
